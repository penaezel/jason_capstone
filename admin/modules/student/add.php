           ...
           <div class="col-md-4">
            <div class="form-group">
                ...
                "bday">Birth Date</label> 
                    ...
                    <input class="form-control" size="11" type="text" value=""  name="bday" id="bday">
    ...
    <fieldset>
      ...
      <div class="form-group">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
            <label class="" for="otherperson">Intermediate School</label> 
              <input class="form-control input-sm" id="otherperson" name=
              "otherperson" placeholder="Intermediate School" type="text">
            </div>
          </div>
          ...
          <div class="col-md-6">
            ...
            <label for="otherAddress">High School</label> 
              ...
              "otherAddress" placeholder="High School" type="text">
            </div>
          </div>
        </div> 
    </fieldset>
