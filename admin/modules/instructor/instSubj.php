        ...
        <form class="form-horizontal span4" action="controller.php?action=delsubj" method="POST">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="glyphicon glyphicon-user"></span> Staff Information </h3>
                </div>
                    ...
                    <div class="row">
                        <div class="container">
                            ...
                            <div class="well">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <p>
                                                        <b>Full Name :
                                                        </b><?php echo (isset($cur)) ? $cur->INST_FULLNAME : 'Fullname' ;?><br />
                                                        <b>Sex :
                                                        </b><?php echo (isset($cur)) ? $cur->INST_SEX  : 'Sex' ;?><br />
                                                        <b>Employment Status :
                                                        </b><?php echo (isset($cur)) ? $cur->EMPLOYMENT_STATUS : 'EMPLOYMENT STATUS' ;?><br />
                                                        <b>Specialization :
                                                        </b><?php echo (isset($cur)) ? $cur->SPECIALIZATION : 'SPECIALIZATION' ;?><br />
                                                        <b>Address :
                                                        </b><?php echo (isset($cur)) ? $cur->INST_ADDRESS : 'Address' ;?>
                                ...
                                <table id="example" class="display" cellspacing="0" width="100%">
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            <th width="10">No</th>
                                            <th width="20%" class="bottom"> <input type="checkbox" name="chkall"
                                                    id="chkall" onclick="return checkall('selector[]');">Subject</th>
				 		...
				 		<th class="bottom">Days and Time</th> -->
                                            <th class="bottom">Course Level</th>
				...
				<tr><td  colspan="7"></td></tr>				  	 
                                ...
                                <div class="btn-group">
                                    ...
                                    <a href="index.php?view=assign&instructorId=<?php  echo (isset($_GET['instructorId'])) ? $_GET['instructorId']: 'ID' ; ?>"
                                        class="btn btn-default"><span class="glyphicon glyphicon-plus-sign"></span>
                                        Assign Subjects</a>
                                    <button type="submit" class="btn btn-default" name="delete"><span
