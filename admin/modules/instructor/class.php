                ...
                <div class="container">
                    ...
                    <form class="form-horizontal span4" action="" method="POST">
                        <table class="table" align="center">
                            ...
                            <tbody>
                                <tr>
                                    <td><strong>Subject Code:</strong>
                                        <?php echo (isset($cur)) ? $cur->SUBJ_CODE : 'Code' ;?><br />
                                        <strong>Description:</strong>
                                        <?php echo (isset($cur)) ? $cur->SUBJ_DESCRIPTION  : 'Description' ;?><br />
                                        <!--	<td><?php //echo (isset($cur)) ? $cur->SEMESTER : 'Semester' ;?></td>-->
                                        <strong>Course:</strong>
                                        <?php echo (isset($cur)) ? $cur->COURSE_DESC : 'Course' ;?><br />
                                        <strong>YEAR LEVEL:</strong>
                                        <?php echo (isset($cur)) ? $cur->YEAR_LEVEL : 'YEAR LEVEL' ;?><br />
                                        <strong>SEMESTER:</strong>
                                        <?php echo (isset($cur)) ? $cur->SEMESTER : 'SEMESTER' ;?><br />
                                        <!--	<td><?php //echo (isset($cur)) ? $cur->COURSE_LEVEL : 'Level' ;?></td>-->

                                        <!-- <strong>Days And Time:</strong>
                                        <?php echo (isset($cur)) ? $cur->DAY . ' ' .$cur->C_TIME : 'DaysTime' ;?><br />
                                        <strong>Room:</strong> <?php echo (isset($cur)) ? $cur->ROOM : 'Room' ;?><br />
                                        <strong>Section:</strong> <?php echo (isset($cur)) ? $cur->SECTION : 'Room' ;?> -->
                                    </td>
	...
	?>
                    <div class="wellss">
				  	...
				  	?>
                            ...
                            <div class="btn-group">
                                <a href="index.php?view=instSubj&instructorId=<?php echo $_GET['instructorId'];?>"
